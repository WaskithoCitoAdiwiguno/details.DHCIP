...
- `index.html` — halaman detail (self-contained: HTML + CSS inline, tanpa build step)
- `dhcip-screenshot.png` — tangkapan layar antarmuka DHCIP
- `README.md` — file ini
...
- `index.html` memuat screenshot dari file lokal `dhcip-screenshot.png` — pastikan keduanya berada di folder yang sama saat di-push.
